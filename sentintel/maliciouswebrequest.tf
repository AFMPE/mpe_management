variable "client_log_analytics_workspace_id" {
  default     = null
  description = "Enter your sentinel or log analytics workspace ID"
  nullable    = false
  sensitive   = true
  type        = string

validation = {
condition = var.client_log_analytics_workspace_id != null
error_message = "Please create a terraform variable named \"client_log_analytics_workspace_id\" and populate it with the ID of your sentinel or log analytics instance."
}
}
resource "my_alert_rule" "rule_211" {
