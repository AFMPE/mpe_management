resource "my_alert_rule" "rule_201" {
  name = "Potential lolbins usage detected AMA"
...
EOF
  ...
  techniques = ['T1105']
  display_name = Potential lolbins usage detected (AMA)
  description = <<EOT
